...
<?php
	...
	//requête préparée
	$add_randonné = $bd->prepare("INSERT INTO hiking(name, difficulty, distance, duration, height_difference) VALUES (:name, :difficulty, :distance, :duration, :height_difference)");

	$add_randonné->execute([
		'name' => $name,
